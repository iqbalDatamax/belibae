...
<div>
			    ...
			    <div>
				    <div class="p-2">
						...
						<div>
		                      ...
		                      <del>{{getCoret(produkid.harga, produkid.diskon)}}</del>
		                      <span class="text-xs px-1 bg-red-300 text-red-800 rounded">{{getDiskon(produkid.harga, produkid.diskon)}}%</span>
		                    </p>
	                    </div>
	                    
						<div class="flex px-2 pt-2">
		                  <p class="text-xs text-gray-600"><i class="fa fa-map-marker-alt"></i> {{produkid.tokos.alamats.desa.kecamatan.namakecamatan}}</p>
		                </div>
		                <div class="py-1 flex justify-between">
		                    <img v-if="produkid.bisakembali" class="w-16 h-9" src="/bisa_dikembalikan.png" alt="bisa kembali" />
		                    <p></p> <!-- bantu -->
	        ...
	        <div class="justify-between w-full">
				<div class="p-2">
					...
					<div class="flex justify-between pb-2 text-sm">
						...
						<div class="font-semibold">{{produkid.tokos.alamats.desa.kecamatan.namakecamatan}}</div>
					</div>
					<div class="flex justify-between pb-2 text-sm">
	...
	<modal name="modal-pesan" :height="'auto'" :scrollable="true" :width="'95%'" :adaptive="true">
	    <div class="pb-4 px-3 py-4">
	    	<h1 class="text-gray-700 font-semibold text-lg mb-4">Tulis catatan pesananmu untuk toko</h1>
	    	<textarea type="text" class="bg-gray-100 rounded w-full text-gray-800 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 pt-2 pb-2 px-3" v-model="pesan" placeholder="Misalnya Warna merah, Ukuran M dll">
	    	</textarea>
