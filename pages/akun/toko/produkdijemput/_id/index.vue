      ...
      <div class="flex p-3 flex-row items-center">
          ...
          <div class="inline-flex w-full">
              <div class="w-full inline-block relative">
                <p class="text-lg text-purple-700">List Produk Dijemput</p>
              </div>
          </div>
      </div>
  </header>
...
//================================================================
    ...
    var data = `?startDate=${dts}&endDate=${dte}&page=0&size=30&status=3&toko=${params.id}`;
    await Promise.all([
  ...
  methods: {
	...
	getDataTanggal() {
	    let data = `?startDate=${this.startDate}&endDate=${this.endDate}&page=0&size=30&status=3&toko=${this.$route.params.id}`
