	        ...
	        <div class="flex p-3 flex-row items-center">
	            ...
	            <div class="inline-flex w-full">
	                <div class="w-full inline-block relative">
				      <p class="text-xl text-purple-700">Keranjang saya</p>
		    		</div>
	            </div>
	        </div>
	    </header>
	    ...
	    <div class="w-full" v-if="transaksiUser != ''">
			<section class="block fixed inset-x-0 bottom-0 z-10 bg-white border-t-2 shadow">
				<div class="flex justify-between">
					...
					<div class="py-3 px-6">
						<nuxt-link :to="{name: 'checkout'}" class="rounded-xl py-3 px-5 text-white hoper:bg-purple-800 bg-purple-700 inline-block text-center">Checkout</nuxt-link>
					</div>
				</div>
			</section>
		</div>
